...
public final class SwitchTabAction extends Action<SwitchtabActionType> {

    @Inject
    public SwitchTabAction(SeleniumHelper seleniumHelper) {
        super(seleniumHelper);
    }

    @Override
    public void execute() {
        int value = this.actionDto.getTabnumber().intValue();
        this.seleniumHelper.switchTabs(value);
    }
