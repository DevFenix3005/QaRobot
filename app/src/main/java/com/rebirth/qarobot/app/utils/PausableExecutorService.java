...
public class PausableExecutorService extends ThreadPoolExecutor {
     ...
     */
    public PausableExecutorService(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue) {
